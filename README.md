You will need the `vbo` and `wav` directories to run the game, they are included in the [release build here](https://github.com/SequinGames/HYPERBOREA/releases/tag/V3). All of the graphical assets are covered under the [CC0 1.0 Universal license](https://creativecommons.org/publicdomain/zero/1.0/):
```
...
## Wow crazy sounds bro! Did you steal those from Doom?
...
## Dude this game looks nuts ᕕ( ᐛ )ᕗ
