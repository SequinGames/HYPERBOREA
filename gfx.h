...
void esDebug(const GLuint state)
{
    ...
    void esRenderModel()
    {
        ...
        glDrawElements(GL_TRIANGLES, esModelArray[esBoundModel].ni, GL_UNSIGNED_INT, 0);
    }
    ...
    {
        if(vbl > MAX_MODEL_SIZE-1){return 0;}
        static uint vc = 0; long eol;
    ...
    {
        if(ibl > MAX_MODEL_SIZE-1){return 0;}
